...
class KeywordSelect extends React.PureComponent {
  ...
  render() {
      ...
      const modifierClass =
      value || filterKeyword ? '' : 'header__input--inactive';
          ...
          >
              <div className="field__wrapper">
                  <fieldset className="header__fieldset">
                      <label className="header__label" htmlFor="keywordselect">
              Filter by single Keyword
                      </label>
                      <select
                          id="keywordselect"
                          className={
                              'header__input header__input--stretched ' + modifierClass
                          }
                          onChange={this.onChange}
                          value={filterKeyword || value || initialValue}
                      >
                          <option disabled value={filterKeyword || initialValue}>
